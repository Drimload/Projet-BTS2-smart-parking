...
// Charge les données et injecte dans la vue
// ============================================================
...
$role = getRole(); // 'Employé' | 'Administrateur'

// Chargement initial des places (le JS prend le relai ensuite)
$places = $pdo->query("
    SELECT
        p.id_place,
        p.numero,
...
// Regroupement par parking pour la vue
$parkings = [];
